...
file_text = read(fpath('../catalog/__meta__.py'))
...
latex_documents = [
    ('index', 'catalog.tex', u'catalog Documentation',
...
man_pages = [
    ('index', 'catalog', u'catalog Documentation',
...
texinfo_documents = [
    ('index', 'catalog', u'catalog Documentation',
        u'Ian Dennis Miller', 'catalog', 'One line description of project.',
        'Miscellaneous'),
]
